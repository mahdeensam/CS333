 ...
 * Course: CS333
 * Task: Project 7
 * Purpose: This program demonstrates proper reference counting when writing C code to interface with Python
 *          using the Python C API. It includes functions to increment and decrement the reference count of
 *          Python objects and to create a new Python integer object.
 */
